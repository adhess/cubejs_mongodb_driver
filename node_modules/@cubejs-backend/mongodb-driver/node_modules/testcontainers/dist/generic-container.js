...
class GenericContainerBuilder {
    constructor(context, dockerfileName, uuid = new uuid_1.RandomUuid(), dockerClientFactory = new docker_client_factory_1.DockerodeClientFactory()) {
    ...
    build() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!(yield container.isImageCached())) {
...
class GenericContainer {
    ...
    start() {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.pullPolicy.shouldPull() || !(yield this.isImageCached())) {
            ...
            (yield container.logs())
                .on("data", (data) => logger_1.default.trace(`${container.getId()}: ${data}`))
                .on("err", (data) => logger_1.default.error(`${container.getId()}: ${data}`));
